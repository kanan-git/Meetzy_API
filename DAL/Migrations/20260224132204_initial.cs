    ...
    public partial class initial : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    ProfileNo1Id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    ProfileNo2Id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "datetime2", nullable: false)
                },
                constraints: table =>
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_HashtagPost", x => new { x.HashtagId, x.PostsId });
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    FeedPageUrl = table.Column<string>(type: "nvarchar(max)", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Profiles_MediaFiles_ProfileImageId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Messages_Profiles_ReceiverProfileId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Notifications_Profiles_TargetProfileId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_PostReactions_Profiles_ProfileId",
                        column: x => x.ProfileId,
                        principalTable: "Profiles",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ActivityLogs_ProfileId",
                table: "ActivityLogs",
                column: "ProfileId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Chats_ProfileNo1Id",
                table: "Chats",
                column: "ProfileNo1Id");

            migrationBuilder.CreateIndex(
                name: "IX_Chats_ProfileNo2Id",
                table: "Chats",
                column: "ProfileNo2Id");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CommentReactions_ProfileId",
                table: "CommentReactions",
                column: "ProfileId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_FriendsLists_ProfileId",
                table: "FriendsLists",
                column: "ProfileId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Notifications_TargetProfileId",
                table: "Notifications",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PostReactions_ProfileId",
                table: "PostReactions",
                column: "ProfileId");
            ...
            migrationBuilder.AddForeignKey(
                name: "FK_Chats_Profiles_ProfileNo1Id",
                table: "Chats",
                column: "ProfileNo1Id",
                principalTable: "Profiles",
                principalColumn: "Id",
            ...
            migrationBuilder.AddForeignKey(
                name: "FK_Chats_Profiles_ProfileNo2Id",
                table: "Chats",
                column: "ProfileNo2Id",
                principalTable: "Profiles",
                principalColumn: "Id",
            ...
            migrationBuilder.AddForeignKey(
                name: "FK_CommentReactions_Profiles_ProfileId",
                table: "CommentReactions",
                column: "ProfileId",
                principalTable: "Profiles",
                principalColumn: "Id");
            ...
            migrationBuilder.AddForeignKey(
                name: "FK_FriendsLists_Profiles_FriendId",
                table: "FriendsLists",
                column: "FriendId",
                principalTable: "Profiles",
                principalColumn: "Id");
            ...
            migrationBuilder.AddForeignKey(
                name: "FK_FriendsLists_Profiles_ProfileId",
                table: "FriendsLists",
                column: "ProfileId",
                principalTable: "Profiles",
                principalColumn: "Id");
